...
I always thought it was done like that as a learning tool.  Once you encounter the gotcha, you learn the hard way, that variables are **captured by reference**!  I found this a useful lesson as I started to use Go's great functional programming features.
{: .notice--warning}
