...
### Trace Tool
As I mentioned last time I was ecstatic about the fixes to the Go Execution Tracer (see [Execution Tracer](/blog/go1p22.html#execution-tracer)).  If you've tried it in the past and been frustrated try it again - **it now works!**
...
The common code example for `unique` interns `string`s like this:
